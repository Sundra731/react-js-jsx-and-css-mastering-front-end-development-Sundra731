...
const useLocalStorageTasks = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 transition-all duration-300 animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="mb-6">
            ...
            <input
                ...
                className="flex-grow px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 transition-all duration-200"
            />
